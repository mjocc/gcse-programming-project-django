"""
Django settings for gcse_programming_project project.
...
SECRET_KEY = "django-insecure-j2ct%mz4y!1hg@n1j-2f5!yz=#6=l!f$@jujkn&r%n26809er%"
...
ALLOWED_HOSTS = [
    ...
    "127.0.0.1",
    "[::1]",
    "c77ee4ac-fda8-4a46-becc-33f285600d8a.id.repl.co",
    "gcse-programming-project-django.17moccleshaw.repl.co",
]
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            "context_processors": [
                ...
                "profit_calculator.views.context_processor",
            ],
        },
    },
]

WSGI_APPLICATION = "gcse_programming_project.wsgi.application"
